...
public class MindstormsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case MindstormsPackage.INSTRUCTIONS: {
		...
		case MindstormsPackage.CHOREOGRAPHY: {
			...
			if (result == null)
				result = caseInstructions(choreography);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MindstormsPackage.ACTION: {
			...
			if (result == null)
				result = caseInstructions(action);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MindstormsPackage.RELEASE: {
			...
			if (result == null)
				result = caseInstructions(release);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MindstormsPackage.GO_FORWARD: {
			...
			if (result == null)
				result = caseInstructions(goForward);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MindstormsPackage.ROTATE: {
			...
			if (result == null)
				result = caseInstructions(rotate);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
