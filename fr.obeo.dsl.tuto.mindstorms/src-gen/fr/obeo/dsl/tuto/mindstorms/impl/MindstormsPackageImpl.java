...
public class MindstormsPackageImpl extends EPackageImpl implements MindstormsPackage {
	...
	public void initializePackageContents() {
		...
		choreographyEClass.getESuperTypes().add(this.getInstructions());
		actionEClass.getESuperTypes().add(this.getInstructions());
		...
		initEReference(getChoreography_Instructions(), this.getInstructions(), null, "instructions", null, 0, -1,
